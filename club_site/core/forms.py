...
class EditProjectForm(forms.ModelForm):
    ...
    preza = forms.FileField(label="Презентация", help_text="<small>презентация вашего проекта, если есть (макс размер 32mb)</small>",  widget=forms.ClearableFileInput(attrs={ 'class': 'form-control-file', 'multiple': False }), required=False)
